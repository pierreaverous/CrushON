...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference("Produit.count") do
      post produits_url, params: { produit: { prix: @produit.prix, stock: @produit.stock, title: @produit.title, vendeur_id: @produit.vendeur_id } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { prix: @produit.prix, stock: @produit.stock, title: @produit.title, vendeur_id: @produit.vendeur_id } }
